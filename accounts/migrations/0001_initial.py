    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='photos/%d/%b/%Y/')),
                ('user_type', models.CharField(choices=[('developer', 'developer'), ('employer', 'employer')], default='developer', max_length=9)),
